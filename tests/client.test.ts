...
describe('CrosspostClient', () => {
	...
	describe('initialization', () => {
		...
		it('should skip disabled platforms', () => {
			...
			expect(testClient.getSupportedPlatforms()).toEqual(['twitter', 'linkedin']);
		});
	});
	...
	describe('scheduling', () => {
		...
		it('should schedule a post', async () => {
			...
			const scheduledPost = await client.schedulePost(testContent, ['twitter'], scheduledAt);
...
describe('LinkedInAdapter', () => {
	...
	it('should format content for LinkedIn', () => {
		...
		const formatted = adapter.formatContent(content);
		expect(formatted.text).toBe('Professional update\n\n#linkedin #professional');
	});
